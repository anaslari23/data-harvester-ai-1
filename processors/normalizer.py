...
def normalize_record(rec: Dict[str, Any]) -> Dict[str, Any]:
    ...
    normalized["employee_count"] = normalize_text(normalized.get("employee_count", ""))
    normalized["branch_count"] = normalize_text(normalized.get("branch_count", ""))
    normalized["turnover"] = normalize_text(normalized.get("turnover", ""))
    normalized["contact_name"] = normalize_text(normalized.get("contact_name", ""))
    normalized["erp_software"] = normalize_text(normalized.get("erp_software", ""))
    return normalized
